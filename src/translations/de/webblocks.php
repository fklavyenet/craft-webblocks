...
return [
    ...
    'Sporty sans-serif, vibrant blue. Clean and energetic.' => 'Sportliches Sans-Serif, lebhaftes Blau. Sauber und energetisch.',
    ...
    'Newspaper-inspired serif typography. Editorial and classic.' => 'Zeitungsinspirierte Serif-Typografie. Redaktionell und klassisch.',
    'Crisp, readable typefaces with generous whitespace. Modern and clean.' => 'Scharfe, lesbare Schriften mit großzügigem Weißraum. Modern und sauber.',
    ...
    'Soft shadows and rounded shapes. Neumorphic and tactile.' => 'Weiche Schatten und abgerundete Formen. Neumorphisch und taktil.',
    'Deep purple primary with vivid accents. Bold and distinctive.' => 'Tiefviolette Primärfarbe mit lebhaften Akzenten. Mutig und unverwechselbar.',
    'Vibrant gradients and glassmorphism. Bold and modern.' => 'Lebhafte Farbverläufe und Glassmorphismus. Mutig und modern.',
    'Warm tan and earthy tones. Natural and approachable.' => 'Warme Sandtöne und Erdfarben. Natürlich und zugänglich.',
    'Hand-drawn comic-book aesthetic. Playful and unconventional.' => 'Handgezeichnete Comic-Ästhetik. Verspielt und unkonventionell.',
    'Muted dark-grey palette. Sophisticated and low-contrast.' => 'Gedämpfte dunkelgraue Palette. Anspruchsvoll und kontrastarmen.',
    'Muted greys and blues with a scientific, dashboard feel.' => 'Gedämpfte Grau- und Blautöne mit einem wissenschaftlichen Dashboard-Gefühl.',
    'Cool sky-blue primary. Light, airy, corporate feel.' => 'Kühles Himmelblau als Primärfarbe. Hell, luftig, korporatives Gefühl.',
    'Ubuntu-inspired orange accent. Warm and community-driven.' => 'Ubuntu-inspirierter orangefarbener Akzent. Warm und gemeinschaftsorientiert.',
    'Calm, rounded components with an approachable blue primary.' => 'Ruhige, abgerundete Komponenten mit einer zugänglichen blauen Primärfarbe.',
    'Airy, minimal layout with subtle blue tones. Lightweight and fresh.' => 'Luftiges, minimales Layout mit dezenten Blautönen. Leicht und frisch.',
