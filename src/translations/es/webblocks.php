...
return [
    ...
    'Sporty sans-serif, vibrant blue. Clean and energetic.' => 'Sans-serif deportivo, azul vibrante. Limpio y enérgico.',
    ...
    'Newspaper-inspired serif typography. Editorial and classic.' => 'Tipografía serif inspirada en periódicos. Editorial y clásica.',
    'Crisp, readable typefaces with generous whitespace. Modern and clean.' => 'Tipografías nítidas y legibles con abundante espacio en blanco. Moderno y limpio.',
    ...
    'Soft shadows and rounded shapes. Neumorphic and tactile.' => 'Sombras suaves y formas redondeadas. Neumórfico y táctil.',
    'Deep purple primary with vivid accents. Bold and distinctive.' => 'Color primario púrpura profundo con acentos vivos. Atrevido y distintivo.',
    'Vibrant gradients and glassmorphism. Bold and modern.' => 'Degradados vibrantes y glassmorphism. Audaz y moderno.',
    'Warm tan and earthy tones. Natural and approachable.' => 'Tonos cálidos tostados y terrosos. Natural y accesible.',
    'Hand-drawn comic-book aesthetic. Playful and unconventional.' => 'Estética de cómic dibujado a mano. Lúdico y poco convencional.',
    'Muted dark-grey palette. Sophisticated and low-contrast.' => 'Paleta gris oscuro apagada. Sofisticada y de bajo contraste.',
    'Muted greys and blues with a scientific, dashboard feel.' => 'Grises y azules apagados con sensación científica de panel de control.',
    ...
    'Ubuntu-inspired orange accent. Warm and community-driven.' => 'Acento naranja inspirado en Ubuntu. Cálido y orientado a la comunidad.',
    'Calm, rounded components with an approachable blue primary.' => 'Componentes tranquilos y redondeados con un azul primario accesible.',
    'Airy, minimal layout with subtle blue tones. Lightweight and fresh.' => 'Diseño aireado y minimalista con tonos azules sutiles. Ligero y fresco.',
