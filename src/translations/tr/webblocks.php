...
return [
    ...
    'Sporty sans-serif, vibrant blue. Clean and energetic.' => 'Sportif sans-serif, canlı mavi. Temiz ve enerjik.',
    ...
    'Newspaper-inspired serif typography. Editorial and classic.' => 'Gazete ilhamli serif tipografi. Editoryal ve klasik.',
    'Crisp, readable typefaces with generous whitespace. Modern and clean.' => 'Bol boşluklu keskin, okunabilir yazı tipleri. Modern ve temiz.',
    ...
    'Soft shadows and rounded shapes. Neumorphic and tactile.' => 'Yumuşak gölgeler ve yuvarlak şekiller. Neumorfik ve dokunsal.',
    'Deep purple primary with vivid accents. Bold and distinctive.' => 'Canlı vurgularla derin mor birincil renk. Cesur ve özgün.',
    'Vibrant gradients and glassmorphism. Bold and modern.' => 'Canlı degradeler ve glassmorphism. Cesur ve modern.',
    'Warm tan and earthy tones. Natural and approachable.' => 'Sıcak kum ve toprak tonları. Doğal ve yakın.',
    'Hand-drawn comic-book aesthetic. Playful and unconventional.' => 'El çizimi çizgi roman estetiği. Eğlenceli ve alışılmadık.',
    'Muted dark-grey palette. Sophisticated and low-contrast.' => 'Sönük koyu gri palet. Sofistike ve düşük kontrastlı.',
    'Muted greys and blues with a scientific, dashboard feel.' => 'Bilimsel, kontrol paneli hissiyle sönük griler ve maviler.',
    'Cool sky-blue primary. Light, airy, corporate feel.' => 'Serin gök mavisi birincil renk. Hafif, ferah, kurumsal his.',
    'Ubuntu-inspired orange accent. Warm and community-driven.' => 'Ubuntu ilhamlı turuncu vurgu. Sıcak ve topluluk odaklı.',
    'Calm, rounded components with an approachable blue primary.' => 'Erişilebilir mavi birincil renkle sakin, yuvarlak bileşenler.',
    'Airy, minimal layout with subtle blue tones. Lightweight and fresh.' => 'Hafif mavi tonlarıyla havadar, minimal düzen. Hafif ve taze.',
